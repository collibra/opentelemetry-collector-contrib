...
func TestStartExporter(t *testing.T) {
	...
	exporter := &pubsubExporter{
		...
		tracesTopicName:  "projects/my-project/topics/my-trace",
		metricsTopicName: "projects/my-project/topics/my-metric",
		logsTopicName:    "projects/my-project/topics/my-log",
	}
...
func TestStartWithNoServer(t *testing.T) {
	...
	exporter.tracesTopicName = "projects/my-project/topics/no-trace"
	assert.Error(t, exporter.Start(ctx, nil))
	exporter.tracesTopicName = ""
	exporter.metricsTopicName = "projects/my-project/topics/no-metric"
	assert.Error(t, exporter.Start(ctx, nil))
	exporter.metricsTopicName = ""
	exporter.logsTopicName = "projects/my-project/topics/no-log"
	assert.Error(t, exporter.Start(ctx, nil))
}
