...
func TestUnsuccessfulScrape(t *testing.T) {
	...
	scraper := newPostgreSQLScraper(receivertest.NewNopCreateSettings(), cfg, newPooledClientFactory(cfg))
...
func (m *mockClientFactory) getClient(_ context.Context, database string) (client, error) {
